...
void main() {
  group('ValidationUtils Tests', () {    test('validateRequired should return error for empty string', () {
    ...
    test('validateNumber should return null for valid number', () {
      ...
      expect(ValidationUtils.validatePrice(''),
          equals('Fiyat gereklidir'));
    ...
    test('validatePrice should return null for valid price', () {
      ...
      expect(
          ValidationUtils.validateYear(''), equals('Yıl gereklidir'));
    ...
    test('validateKilometers should return null for valid kilometers', () {
      ...
      expect(ValidationUtils.validatePhone('123'),
          equals('Geçerli bir telefon numarası giriniz'));
      expect(ValidationUtils.validatePhone('051234567890'), // 11 haneli
          equals('Geçerli bir telefon numarası giriniz'));
      expect(ValidationUtils.validatePhone('04123456789'), // 4 ile başlayan
          equals('Geçerli bir telefon numarası giriniz'));
